...
export const ROLE_PERMISSIONS = {
  ...
  sales_director: [P.DASHBOARD, P.CONTACTS_VIEW_OWN, P.OPPS_VIEW_OWN, P.DEALS_VIEW_OWN, P.COMM_VIEW_OWN, P.PROJECTS_VIEW, P.UNITS_VIEW, P.RPT_SALES, P.POOL_VIEW, P.POOL_MANAGE, P.POOL_ASSIGN, P.POOL_VIEW_FRESH, P.POOL_SETTINGS, P.TASKS_VIEW_OWN, P.CALENDAR, P.CHAT_USE],
  sales_manager:  [P.DASHBOARD, P.CONTACTS_VIEW_OWN, P.OPPS_VIEW_OWN, P.DEALS_VIEW_OWN, P.PROJECTS_VIEW, P.UNITS_VIEW, P.RPT_SALES, P.POOL_VIEW, P.POOL_MANAGE, P.POOL_ASSIGN, P.POOL_VIEW_FRESH, P.POOL_SETTINGS, P.TASKS_VIEW_OWN, P.CALENDAR, P.CHAT_USE],
  team_leader:    [P.DASHBOARD, P.CONTACTS_VIEW_OWN, P.OPPS_VIEW_OWN, P.DEALS_VIEW_OWN, P.PROJECTS_VIEW, P.UNITS_VIEW, P.POOL_VIEW, P.POOL_MANAGE, P.POOL_ASSIGN, P.POOL_VIEW_FRESH, P.TASKS_VIEW_OWN, P.CALENDAR, P.CHAT_USE],
