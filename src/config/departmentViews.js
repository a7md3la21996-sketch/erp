...
export const DEPT_VIEWS = {
  sales: {
    ...
    statusOptions: ['new', 'active', 'has_opportunity', 'not_interested', 'inactive', 're_engage', 'disqualified'],
    // Sort options
  ...
  hr: {
    ...
    statusOptions: ['new', 'active', 'has_opportunity', 'not_interested', 'inactive', 'disqualified'],
  ...
  finance: {
    ...
    statusOptions: ['new', 'active', 'has_opportunity', 'not_interested', 'inactive'],
    sortIds: ['created', 'name', 'last_activity'],
  ...
  marketing: {
    ...
    statusOptions: ['new', 'active', 'has_opportunity', 'not_interested', 'inactive', 're_engage'],
