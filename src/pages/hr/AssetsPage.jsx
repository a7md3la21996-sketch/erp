...
function loadData() {
  ...
  localStorage.setItem(STORAGE_KEY, JSON.stringify(DEFAULT_ASSETS)); syncToSupabase('platform_hr_assets', DEFAULT_ASSETS);
  return [...DEFAULT_ASSETS];
}

function saveData(data) {
  try { localStorage.setItem(STORAGE_KEY, JSON.stringify(data)); syncToSupabase('platform_hr_assets', data); } catch {}
}
