...
const HELP_DATA = [
  ...
  // ── CRM ──
  {
    ...
    features: {
      ar: ['إضافة/تعديل/حذف جهات الاتصال', 'إجراءات جماعية', 'استيراد/تصدير من Excel', 'فلاتر ذكية', 'سجل التدقيق', 'المفضلة والقائمة السوداء', 'دمج جهات الاتصال المكررة', 'حالة "غير مؤهل" مع أسباب الاستبعاد', 'إنشاء فرص جماعي لجهات الاتصال المحددة', 'وضع الاتصال الجماعي مع واتساب وتخطي وإنشاء مهام وملخص', 'حد الدمج وأقصى عدد تثبيت قابل للتكوين من الإعدادات', 'عمود المعينين/الفرص يعرض مراحل وكيل المبيعات'],
      en: ['Add/edit/delete contacts', 'Bulk actions', 'Import/export from Excel', 'Smart filters', 'Audit trail', 'Favorites & blacklist', 'Merge duplicate contacts', 'Disqualified status with exclusion reasons', 'Bulk create opportunities for selected contacts', 'Batch call mode with WhatsApp, skip, task creation, and summary', 'Configurable merge limit and max pins from settings', 'Assignees/opportunities column showing sales agent stages'],
    },
    howTo: {
      ar: [
        ...
        'لاستبعاد جهة اتصال: غيّر الحالة إلى "غير مؤهل" وأدخل سبب الاستبعاد.',
        'لإنشاء فرص جماعي: حدد جهات الاتصال ثم اضغط "إنشاء فرص" من شريط الإجراءات الجماعية.',
        'لوضع الاتصال الجماعي: حدد جهات الاتصال واضغط "اتصال جماعي" للتنقل بينها مع خيارات واتساب وتخطي وإنشاء مهمة.',
        'لتعديل حد الدمج أو أقصى تثبيت: انتقل إلى الإعدادات > جهات الاتصال وعدّل القيم.',
      ],
      en: [
        ...
        'To disqualify a contact: Change status to "Disqualified" and enter the exclusion reason.',
        'To bulk create opportunities: Select contacts then click "Create Opportunities" from the bulk actions bar.',
        'To use batch call mode: Select contacts and click "Batch Call" to cycle through them with WhatsApp, skip, and task options.',
        'To adjust merge limit or max pins: Go to Settings > Contacts and modify the values.',
      ],
    },
    tips: {
    ...
    relatedSettings: { ar: 'حقول مخصصة، أنواع جهات الاتصال، الأقسام، إعدادات جهات الاتصال', en: 'Custom Fields, Contact Types, Departments, Contacts Settings' },
  },
  {
    id: 'opportunities',
    category: 'crm',
    ...
    features: {
      ar: ['إدارة المراحل', 'درجة الحرارة والأولوية', 'عرض جدول (افتراضي) وعرض كانبان', 'تحويل إلى صفقة', 'الأنشطة والمتابعات', 'المستندات والتعليقات', 'نظام تقييم العملاء المحتملين (تلقائي بناءً على الحرارة والميزانية والمرحلة والحداثة)', 'مؤشر الفرص السريعة للفرص الساخنة القريبة من الإغلاق', 'نتائج الأنشطة عند التسجيل (رد/لا رد/مشغول إلخ)', 'توقعات خط الأنابيب الموزونة', 'تحليل الخسائر مع تتبع الأسباب', 'عمليات جماعية (نقل، تعيين، حرارة، أولوية، تاريخ إغلاق، حذف)', 'فلاتر محفوظة', 'سحب وإفلات في الكانبان', 'تتبع تاريخ الإغلاق المتوقع مع تنبيهات التأخير', 'تتبع سجل المراحل', 'تذكيرات المتابعة في الدرج', 'مؤشرات متوسط حجم الصفقة ووقت الإغلاق'],
      en: ['Stage management', 'Temperature & priority', 'Table view (default) and Kanban view', 'Deal conversion', 'Activities & follow-ups', 'Documents & comments', 'Lead scoring system (auto-calculated from temperature, budget, stage, recency)', 'Quick Wins indicator for hot opportunities near closing', 'Activity results when logging (answered/no answer/busy etc.)', 'Weighted pipeline forecast', 'Loss analysis with reason tracking', 'Bulk operations (move, assign, temperature, priority, close date, delete)', 'Saved filters', 'Drag-and-drop in Kanban', 'Expected close date tracking with overdue alerts', 'Stage history tracking', 'Follow-up reminders in drawer', 'Average deal size and close time KPIs'],
    },
    howTo: {
      ar: [
        ...
        'لتسجيل نشاط: اضغط "إضافة نشاط" واختر النوع والنتيجة (رد/لا رد/مشغول).',
        'لإضافة متابعة: حدد تاريخ المتابعة القادم من تقويم المتابعات.',
        'للتبديل بين الجدول والكانبان: اضغط على أيقونة العرض في شريط الأدوات.',
        'لعرض تقييم العميل: يظهر تلقائيًا في بطاقة الفرصة بناءً على الحرارة والميزانية والمرحلة.',
        'لاستخدام العمليات الجماعية: حدد عدة فرص ثم اختر الإجراء من شريط الإجراءات الجماعية.',
        'لحفظ فلتر: اضبط الفلاتر المطلوبة ثم اضغط "حفظ الفلتر" لإعادة استخدامه.',
        'لتحليل الخسائر: عند إغلاق فرصة كخسارة، أدخل سبب الخسارة لتتبعه في التقارير.',
        'لعرض سجل المراحل: افتح الدرج الجانبي وانتقل إلى تبويب سجل المراحل.',
      ],
      en: [
        ...
        'To log an activity: Click "Add Activity", select the type and result (answered/no answer/busy).',
        'To add a follow-up: Set the next follow-up date from the follow-up calendar.',
        'To switch between table and Kanban: Click the view icon in the toolbar.',
        'To view lead score: It appears automatically on the opportunity card based on temperature, budget, and stage.',
        'To use bulk operations: Select multiple opportunities then choose an action from the bulk actions bar.',
        'To save a filter: Set the desired filters then click "Save Filter" to reuse it later.',
        'To analyze losses: When closing an opportunity as lost, enter the loss reason for report tracking.',
        'To view stage history: Open the side drawer and navigate to the Stage History tab.',
      ],
    },
    tips: {
      ar: 'يمكن تخصيص المراحل حسب كل قسم. استخدم أسباب الخسارة لتحليل لماذا تفشل بعض الفرص وتحسين معدل التحويل. راقب مؤشر الفرص السريعة للتركيز على الصفقات الأقرب للإغلاق.',
      en: 'Stages can be customized per department. Use lost reasons to analyze why some opportunities fail and improve your conversion rate. Watch the Quick Wins indicator to focus on deals closest to closing.',
    },
    relatedSettings: { ar: 'إعدادات النظام > المراحل، أسباب الخسارة، نتائج الأنشطة', en: 'System Config > Stages, Lost Reasons, Activity Results' },
  },
  {
    id: 'lead-pool',
    category: 'crm',
  ...
  // ── Activities ──
  {
    ...
    features: {
      ar: ['تسجيل الأنشطة حسب النوع', 'جدولة الأنشطة المستقبلية أو تسجيلها فورًا', 'حالة النشاط (مجدول/مكتمل/ملغي)', 'نتائج الأنشطة حسب النوع من إعدادات النظام (رد/لا رد/مشغول إلخ)', 'عرض الجدول الزمني', 'ربط الأنشطة بجهات الاتصال والفرص'],
      en: ['Log activities by type', 'Schedule future activities or log now', 'Activity status (scheduled/completed/cancelled)', 'Activity results per type from system config (answered/no answer/busy etc.)', 'Timeline view', 'Link activities to contacts and opportunities'],
    },
    howTo: {
      ar: [
        'لتسجيل نشاط: اضغط "نشاط جديد" واختر النوع وأدخل التفاصيل.',
        'لجدولة نشاط مستقبلي: عند إنشاء النشاط، اختر "جدولة" بدلاً من "تسجيل الآن" وحدد التاريخ والوقت.',
        'لتحديد تاريخ متابعة: حدد تاريخ المتابعة القادم عند إنشاء أو تعديل النشاط.',
        'لتسجيل نتيجة النشاط: عند تسجيل النشاط اختر النتيجة المناسبة (رد/لا رد/مشغول) من القائمة.',
        'لتغيير حالة النشاط: اضغط على حالة النشاط للتبديل بين مجدول ومكتمل وملغي.',
      ...
      en: [
        ...
        'To schedule a future activity: When creating, choose "Schedule" instead of "Log Now" and set the date/time.',
        'To set a follow-up date: Set the next follow-up date when creating or editing an activity.',
        'To record activity result: When logging the activity, select the appropriate result (answered/no answer/busy) from the list.',
        'To change activity status: Click the activity status to toggle between scheduled, completed, and cancelled.',
        'To view timeline: Switch to timeline view to see all activities in chronological order.',
      ],
    },
    tips: {
      ar: 'سجل كل تفاعل مع العميل لبناء سجل كامل يساعد الفريق بأكمله على فهم تاريخ العلاقة. استخدم الجدولة للمتابعات المستقبلية حتى لا تنسى.',
      en: 'Log every customer interaction to build a complete record that helps the entire team understand the relationship history. Use scheduling for future follow-ups so nothing is missed.',
    },
    relatedSettings: { ar: 'أنواع الأنشطة ونتائجها في إعدادات النظام', en: 'Activity Types and Results in System Config' },
  },
  // ── Tasks ──
  {
    id: 'tasks',
  ...
  },
  {
    ...
    overview: {
      ar: 'إعدادات النظام الشاملة بما في ذلك أسباب الخسارة والمصادر وأنواع الأنشطة ونتائجها وإعدادات جهات الاتصال وإعدادات عامة.',
      en: 'System-wide settings including lost reasons, sources, activity types and results, contacts settings, and general configuration.',
    },
    features: {
      ar: ['إعدادات جهات الاتصال (حد الدمج، أقصى عدد تثبيت)', 'تكوين أنواع الأنشطة ونتائجها لكل نوع', 'تكوين أسباب الخسارة', 'إدارة المصادر والأقسام'],
      en: ['Contacts settings (merge limit, max pins)', 'Activity types and results configuration per type', 'Lost reasons configuration', 'Sources and departments management'],
    },
    howTo: {
      ar: [
        'لتعديل الإعدادات: انتقل إلى إعدادات النظام وعدّل القيم المطلوبة.',
        'لتعديل إعدادات جهات الاتصال: انتقل إلى إعدادات النظام > جهات الاتصال لضبط حد الدمج وأقصى عدد تثبيت.',
        'لتكوين نتائج الأنشطة: انتقل إلى إعدادات النظام > أنواع الأنشطة وأضف النتائج لكل نوع.',
        'لإدارة أسباب الخسارة: انتقل إلى إعدادات النظام > أسباب الخسارة لإضافة أو تعديل الأسباب.',
      ],
      en: [
        'To modify settings: Navigate to System Config and edit the required values.',
        'To adjust contacts settings: Go to System Config > Contacts to set merge limit and max pins.',
        'To configure activity results: Go to System Config > Activity Types and add results per type.',
        'To manage lost reasons: Go to System Config > Lost Reasons to add or edit reasons.',
      ],
    },
