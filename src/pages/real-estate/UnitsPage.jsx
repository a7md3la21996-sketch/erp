...
// ── Mock Units ───────────────────────────────────────────────
const DEFAULT_UNITS = [
  { id: 'u1',  project_id: 'p1',  project_ar: 'سيليا',          project_en: 'Celia',              unit_code: 'A-101', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 150, floor: 1, bedrooms: 3, bathrooms: 2, price: 3500000, status: 'available',          view: 'garden',    created_at: '2025-06-15' },
  { id: 'u2',  project_id: 'p1',  project_ar: 'سيليا',          project_en: 'Celia',              unit_code: 'A-204', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 120, floor: 2, bedrooms: 2, bathrooms: 1, price: 2800000, status: 'reserved',           view: 'street',    created_at: '2025-06-20' },
  { id: 'u3',  project_id: 'p1',  project_ar: 'سيليا',          project_en: 'Celia',              unit_code: 'B-501', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 180, floor: 5, bedrooms: 3, bathrooms: 2, price: 4500000, status: 'sold',               view: 'landscape', created_at: '2025-07-01' },
  { id: 'u4',  project_id: 'p1',  project_ar: 'سيليا',          project_en: 'Celia',              unit_code: 'C-302', type_ar: 'دوبلكس',    type_en: 'Duplex',    type: 'duplex',    area: 250, floor: 3, bedrooms: 4, bathrooms: 3, price: 5500000, status: 'sold',               view: 'garden',    created_at: '2025-07-10' },
  { id: 'u5',  project_id: 'p1',  project_ar: 'سيليا',          project_en: 'Celia',              unit_code: 'A-712', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 160, floor: 7, bedrooms: 3, bathrooms: 2, price: 3800000, status: 'sold',               view: 'open',      created_at: '2025-07-15' },
  { id: 'u6',  project_id: 'p1',  project_ar: 'سيليا',          project_en: 'Celia',              unit_code: 'PH-01', type_ar: 'بنتهاوس',   type_en: 'Penthouse', type: 'penthouse', area: 320, floor: 10, bedrooms: 4, bathrooms: 3, price: 8000000, status: 'available',          view: 'open',      created_at: '2025-08-01' },
  { id: 'u7',  project_id: 'p2',  project_ar: 'ريفان',          project_en: 'Rivan',              unit_code: 'A-410', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 130, floor: 4, bedrooms: 2, bathrooms: 1, price: 1800000, status: 'sold',               view: 'pool',      created_at: '2025-08-10' },
  { id: 'u8',  project_id: 'p2',  project_ar: 'ريفان',          project_en: 'Rivan',              unit_code: 'B-108', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 140, floor: 1, bedrooms: 2, bathrooms: 2, price: 2100000, status: 'sold',               view: 'garden',    created_at: '2025-08-15' },
  { id: 'u9',  project_id: 'p2',  project_ar: 'ريفان',          project_en: 'Rivan',              unit_code: 'V-12',  type_ar: 'فيلا',      type_en: 'Villa',     type: 'villa',     area: 350, floor: 0, bedrooms: 5, bathrooms: 4, price: 7200000, status: 'reserved',           view: 'landscape', created_at: '2025-09-01' },
  { id: 'u10', project_id: 'p2',  project_ar: 'ريفان',          project_en: 'Rivan',              unit_code: 'C-305', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 155, floor: 3, bedrooms: 3, bathrooms: 2, price: 2400000, status: 'available',          view: 'pool',      created_at: '2025-09-10' },
  { id: 'u11', project_id: 'p3',  project_ar: 'تاون جيت',       project_en: 'Town Gate',          unit_code: 'TH-03', type_ar: 'تاون هاوس', type_en: 'Townhouse', type: 'townhouse', area: 220, floor: 0, bedrooms: 4, bathrooms: 3, price: 4100000, status: 'sold',               view: 'corner',    created_at: '2025-09-20' },
  { id: 'u12', project_id: 'p3',  project_ar: 'تاون جيت',       project_en: 'Town Gate',          unit_code: 'TH-08', type_ar: 'تاون هاوس', type_en: 'Townhouse', type: 'townhouse', area: 200, floor: 0, bedrooms: 3, bathrooms: 2, price: 3200000, status: 'reserved',           view: 'garden',    created_at: '2025-10-01' },
  { id: 'u13', project_id: 'p3',  project_ar: 'تاون جيت',       project_en: 'Town Gate',          unit_code: 'A-201', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 110, floor: 2, bedrooms: 2, bathrooms: 1, price: 2200000, status: 'available',          view: 'street',    created_at: '2025-10-10' },
  { id: 'u14', project_id: 'p5',  project_ar: 'مستقبل سيتي',    project_en: 'Mostakbal City',     unit_code: 'D-105', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 165, floor: 1, bedrooms: 3, bathrooms: 2, price: 3200000, status: 'available',          view: 'landscape', created_at: '2025-10-20' },
  { id: 'u15', project_id: 'p5',  project_ar: 'مستقبل سيتي',    project_en: 'Mostakbal City',     unit_code: 'V-05',  type_ar: 'فيلا',      type_en: 'Villa',     type: 'villa',     area: 400, floor: 0, bedrooms: 5, bathrooms: 4, price: 9000000, status: 'under_construction', view: 'lake',      created_at: '2025-11-01' },
  { id: 'u16', project_id: 'p5',  project_ar: 'مستقبل سيتي',    project_en: 'Mostakbal City',     unit_code: 'S-301', type_ar: 'استوديو',   type_en: 'Studio',    type: 'studio',    area: 55,  floor: 3, bedrooms: 0, bathrooms: 1, price: 2000000, status: 'available',          view: 'open',      created_at: '2025-11-10' },
  { id: 'u17', project_id: 'p7',  project_ar: 'هايد بارك',      project_en: 'Hyde Park',          unit_code: 'HP-210', type_ar: 'شقة',      type_en: 'Apartment', type: 'apartment', area: 190, floor: 2, bedrooms: 3, bathrooms: 2, price: 5500000, status: 'available',          view: 'garden',    created_at: '2025-11-20' },
  { id: 'u18', project_id: 'p7',  project_ar: 'هايد بارك',      project_en: 'Hyde Park',          unit_code: 'HP-V03', type_ar: 'فيلا',     type_en: 'Villa',     type: 'villa',     area: 500, floor: 0, bedrooms: 6, bathrooms: 5, price: 18000000, status: 'reserved',          view: 'lake',      created_at: '2025-12-01' },
  { id: 'u19', project_id: 'p9',  project_ar: 'بالم هيلز',      project_en: 'Palm Hills NC',      unit_code: 'PH-C12', type_ar: 'شقة',      type_en: 'Apartment', type: 'apartment', area: 100, floor: 1, bedrooms: 2, bathrooms: 1, price: 6000000, status: 'available',          view: 'pool',      created_at: '2025-12-10' },
  { id: 'u20', project_id: 'p9',  project_ar: 'بالم هيلز',      project_en: 'Palm Hills NC',      unit_code: 'PH-V01', type_ar: 'فيلا',     type_en: 'Villa',     type: 'villa',     area: 300, floor: 0, bedrooms: 4, bathrooms: 3, price: 25000000, status: 'sold',              view: 'landscape', created_at: '2025-12-20' },
  { id: 'u21', project_id: 'p10', project_ar: 'بلو تري',        project_en: 'Blue Tree',          unit_code: 'D-105', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 90,  floor: 1, bedrooms: 2, bathrooms: 1, price: 1350000, status: 'sold',               view: 'street',    created_at: '2026-01-05' },
  { id: 'u22', project_id: 'p10', project_ar: 'بلو تري',        project_en: 'Blue Tree',          unit_code: 'E-203', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 100, floor: 2, bedrooms: 2, bathrooms: 1, price: 1650000, status: 'reserved',           view: 'garden',    created_at: '2026-01-15' },
  { id: 'u23', project_id: 'p10', project_ar: 'بلو تري',        project_en: 'Blue Tree',          unit_code: 'F-101', type_ar: 'شقة',       type_en: 'Apartment', type: 'apartment', area: 85,  floor: 1, bedrooms: 2, bathrooms: 1, price: 950000,  status: 'available',          view: 'street',    created_at: '2026-01-25' },
  { id: 'u24', project_id: 'p4',  project_ar: 'ال بوسكو',       project_en: 'IL Bosco',           unit_code: 'IB-401', type_ar: 'دوبلكس',   type_en: 'Duplex',    type: 'duplex',    area: 280, floor: 4, bedrooms: 4, bathrooms: 3, price: 8500000, status: 'sold',               view: 'landscape', created_at: '2026-02-01' },
  { id: 'u25', project_id: 'p4',  project_ar: 'ال بوسكو',       project_en: 'IL Bosco',           unit_code: 'IB-PH2', type_ar: 'بنتهاوس',  type_en: 'Penthouse', type: 'penthouse', area: 350, floor: 12, bedrooms: 5, bathrooms: 4, price: 12000000, status: 'sold',              view: 'open',      created_at: '2026-02-10' },
  { id: 'u26', project_id: 'p8',  project_ar: 'سوديك ايست',     project_en: 'Sodic East',         unit_code: 'SE-101', type_ar: 'شقة',      type_en: 'Apartment', type: 'apartment', area: 170, floor: 1, bedrooms: 3, bathrooms: 2, price: 5500000, status: 'under_construction', view: 'garden',    created_at: '2026-02-20' },
  { id: 'u27', project_id: 'p8',  project_ar: 'سوديك ايست',     project_en: 'Sodic East',         unit_code: 'SE-V01', type_ar: 'فيلا',     type_en: 'Villa',     type: 'villa',     area: 450, floor: 0, bedrooms: 5, bathrooms: 4, price: 20000000, status: 'under_construction', view: 'corner',    created_at: '2026-03-01' },
  { id: 'u28', project_id: 'p6',  project_ar: 'ماونتن فيو',     project_en: 'Mountain View iCity', unit_code: 'MV-305', type_ar: 'شقة',     type_en: 'Apartment', type: 'apartment', area: 175, floor: 3, bedrooms: 3, bathrooms: 2, price: 6500000, status: 'sold',               view: 'landscape', created_at: '2026-03-10' },
];
