...
export const DEAL_STATUS_CONFIG = {
  new_deal:        { ar: 'صفقة جديدة',     en: 'New Deal',         color: '#2F6BD3', bg: 'rgba(74,122,171,0.12)',  step: 1 },
  ...
  cancelled:       { ar: 'ملغي',           en: 'Cancelled',        color: '#D6403B', bg: 'rgba(239,68,68,0.08)',   step: 0 },
};

export const PAYMENT_STATUS_CONFIG = {
  upcoming: { ar: 'قادم',   en: 'Upcoming', color: '#6B8DB5', bg: 'rgba(107,141,181,0.12)' },
  due:      { ar: 'مستحق',  en: 'Due',      color: '#DD6327', bg: 'rgba(249,115,22,0.10)'  },
  overdue:  { ar: 'متأخر',  en: 'Overdue',  color: '#D6403B', bg: 'rgba(239,68,68,0.08)'   },
  paid:     { ar: 'مدفوع',  en: 'Paid',     color: '#2B4C6F', bg: 'rgba(43,76,111,0.12)'   },
  partial:  { ar: 'جزئي',   en: 'Partial',  color: '#2F6BD3', bg: 'rgba(74,122,171,0.12)'  },
};

export const HANDOVER_STATUS_CONFIG = {
  reserved:            { ar: 'محجوز',        en: 'Reserved',           color: '#2F6BD3', bg: 'rgba(74,122,171,0.12)' },
...
export const TICKET_STATUS_CONFIG = {
  open:        { ar: 'مفتوح',       en: 'Open',        color: '#D6403B', bg: 'rgba(239,68,68,0.08)'  },
  in_progress: { ar: 'قيد المعالجة', en: 'In Progress', color: '#DD6327', bg: 'rgba(249,115,22,0.10)' },
  waiting:     { ar: 'بانتظار رد',  en: 'Waiting',     color: '#6B8DB5', bg: 'rgba(107,141,181,0.12)' },
  resolved:    { ar: 'تم الحل',     en: 'Resolved',    color: '#2F6BD3', bg: 'rgba(74,122,171,0.12)' },
  closed:      { ar: 'مغلق',       en: 'Closed',      color: '#2B4C6F', bg: 'rgba(43,76,111,0.12)' },
};

export const TICKET_TYPE_CONFIG = {
  complaint:    { ar: 'شكوى',         en: 'Complaint',    color: '#D6403B' },
  maintenance:  { ar: 'صيانة',        en: 'Maintenance',  color: '#DD6327' },
  inquiry:      { ar: 'استفسار',      en: 'Inquiry',      color: '#2F6BD3' },
