...
export const AVAILABLE_WIDGETS = [
  ...
  {
    id: 'team_activity',
    title_ar: 'نشاط الفريق اليوم',
    title_en: "Team Activity Today",
    description_ar: 'كل سيلز عمل كام مكالمة/واتساب/مقابلة النهاردة',
    description_en: 'Calls, WhatsApp, meetings per agent today',
    category: 'general',
    defaultSize: 'md',
  },
  {
    ...
    description_ar: 'تنبيهات عن ليدز وفرص ومهام محتاجة اهتمام',
    description_en: 'Alerts about leads, opps, and tasks needing attention',
    category: 'general',
    defaultSize: 'md',
  },
  {
    id: 'conversion_funnel',
    title_ar: 'قمع التحويل',
    title_en: 'Conversion Funnel',
    description_ar: 'عدد الفرص في كل مرحلة',
    description_en: 'Opportunities count per stage',
    category: 'sales',
    defaultSize: 'md',
  },
  {
